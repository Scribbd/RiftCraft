...
import nl.scribblon.riftcraft.block.*;
...
public class ModBlocks {
    ...
    public static void init(){
        ...
        GameRegistry.registerBlock(dormantQuartz, Names.Blocks.ACTIVATED_QUARTS);

        //RiftCraft Blocks
        GameRegistry.registerBlock(activatedQuartz, Names.Blocks.ACTIVATED_QUARTS);
